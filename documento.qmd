...
subtitle: "Análisis de Datos Multinivel<br>Profesor: Juan Carlos Castillo<br>Ayudante: Kevin Carrasco" 
author: "Cristóbal Mejías y Victoria Arias" 
date: "06/30/2025" 
lang: es 
format:
  html:
    theme: [pulse, multinivel_informe.scss] 
    math: mathjax
    code-fold: true
    toc: true
    toc-depth: 3           
...
![](output/graf/grafico_efecto_aleatorio.png){fig-align="center"}
...
![](output/graf/grafico_interacción.png){fig-align="center"}
